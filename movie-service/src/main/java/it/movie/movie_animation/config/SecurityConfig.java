    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/auth/get-me/**", "/api/v1/movie/latest-by-subcategory/**", "/api/v1/genre", "/api/v1/movie/**", "/api/v1/movie/list", "/api/v1/movie/random", "/api/v1/genres", "/api/v1/files/**", "/api/v1/movie/active/**", "/api/v1/movie/by-genre/**", "/api/v1/movie/new-serial/**").permitAll()
