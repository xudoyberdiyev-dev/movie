...
//    }
    ...
    @PostMapping("/like-send/{id}")
    public ApiResponse sendLike(@PathVariable UUID id, Authentication authentication) {
        return movieService.sendLike(id, authentication);
    }

    @GetMapping("/like/{id}")
    public ApiResponse getLike(@PathVariable UUID id, Authentication authentication) {
        return movieService.getLike(id, authentication);
    }

//    @PostMapping("/like/{id}")
//    private HttpEntity<?> sendLike(@PathVariable UUID id, Authentication authentication) {
